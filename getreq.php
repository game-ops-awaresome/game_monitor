...
include("wx_forward/weixin.class.php");
...
//$postStr = $GLOBALS["HTTP_RAW_POST_DATA"];
$postStr="<xml>
	<ToUserName><![CDATA[1111]]></ToUserName>
	<FromUserName><![CDATA[22222]]></FromUserName>
	<CreateTime>1348831860</CreateTime>
	<MsgType><![CDATA[text]]></MsgType>
	<Content><![CDATA[l@古荡-九堡]]></Content>
</xml>";
$weixin = new Weixin($postStr);
